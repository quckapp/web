...
// Custom SVG icons for social providers (lucide-react doesn't have brand icons)
const GoogleIcon = () => (
      ...
      {providers.map((provider) => {
        ...
        return (
          <button
            key={provider.id}
            type="button"
            onClick={() => handleSocialLogin(provider.id, provider.loginFn)}
            disabled={isDisabled}
            className={`
              w-full py-3 px-4
